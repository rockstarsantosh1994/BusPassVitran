package com.rockstar.buspassvitran.sharedpreference;
...
public class SPLib {
    ...
    public class Key
    {
        ...
        public static final String Sp_subphonenumber= "Sp_subphonenumber" ;
        public static final String Sp_subfirstname= "Sp_subfirstname" ;
        public static final String Sp_subsubtodate= "Sp_subsubtodate" ;
